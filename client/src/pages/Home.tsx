...
const projects = [
  ...
  { id: 4, title: "OJTask",                      description: "An internship management platform built for Filipino OJT students — tracks hours, daily scrum reports, MOA documents, and practicum records in one organized workspace.", technologies: ["React","TypeScript","Node.js","PostgreSQL"], imageUrl: "/ojtask.png", projectUrl: "https://ojtask-wzzv.onrender.com/", repoUrl: "https://github.com/neowiseeeeeee" },
];
